...
public class UtenteServiceImpl implements UtenteService {
	...
	@Override
	public List<Utente> cercaTuttiUtentiData() {
		// TODO Auto-generated method stub
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
	...
	public Long contaUtentiAdmin() {
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return utenteDAO.countAllByAdmin();
	...
	@Override
	public List<Utente> cercaUtentiConPasswordMinore() {
		// TODO Auto-generated method stub
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return utenteDAO.findByPassword();
	...
	public boolean adminDisabilitati() {
		...
		try {
			...
			if (utenteDAO.findByDisabledAdmin().size() != 0) {
				return true;
			}
			return false;
	...
	@Override
	public List<String> cercaUtentiConDescrizioneRuoli() {
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return utenteDAO.findAllByRuoloDescrizione();
